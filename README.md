# ⚡ מגמת אלקטרוניקה ומחשבים — סימולטור למידה אינטראקטיבי
...
1. פתחו [sheets.google.com](https://sheets.google.com) וצרו גיליון חדש (למשל "מגמת אלקטרוניקה ומחשבים - נתונים").
